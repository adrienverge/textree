 ...
 * That event is unshifted back to IN before the "end" event if generated.
 */
...
EndWithLevelStream.prototype.endLevel = function() {
  console.log("EndWithLevelStream#endLevel");
  // console.trace("EndWithLevelStream#endLevel");
  this.end();
  console.log("END");
  this.defer.resolve();
  console.log("END2");
  ...
  this.captureFirstText()
    ...
    .then(function(templateBuffer /* of events to apply when selector is met */) {
      ...
      this.addMatch(selector, function(event, selectors) {
        ...
        console.log("..unshifting readables");
