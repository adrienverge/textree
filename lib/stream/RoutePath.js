...
var ReadFile = require("./export/ReadFile");
var ParseTextree = require("./export/ParseTextree");
...
RoutePath.prototype.stream = function () {
  return this.resolveRoute()
    .then(function(isEnd) {
      ...
      if (this.isTT) {
        stream = new ParseTextree();
        readFile.pipe(stream);
      } else if (this.extension && this.types[this.extension]) {
        readFile.write({type: "meta", name: "type", value: this.types[this.extension]});
      }
