...
Text2trees.prototype._transform = function (chunk, encoding, done, arg) {
  ...
  // console.log("Text2trees: _transform", chunk);
...
Text2trees.prototype.getLastStartEvent = function (showError) {
 ...
 */
Text2trees.prototype.goForCommentLine = function(commentToken, keep) {
  var _this = this;
...
Text2trees.prototype.goForAttributeLine = function() {
  this.readTokenUntil("\n")
    .then(function(line) {
      this.pos++;
      line = line.trim();
...
Text2trees.prototype.processAttribute = function(token) {
...
Text2trees.prototype.warn = function () {
